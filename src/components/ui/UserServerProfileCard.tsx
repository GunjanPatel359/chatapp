...
interface UserServerProfileCardProps {
  profile: Profile;
  isOpen: boolean;
  onClose: () => void;
...
const UserServerProfileCard: React.FC<UserServerProfileCardProps> = ({ profile, isOpen, onClose, triggerRef }) => {
  console.log('UserServerProfileCard', profile);
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="px-6 pb-4">
            ...
            <p className="text-sm text-indigo-500 mb-2">@{profile.name} &#x25CF; {profile.pronoun}</p>
            <p className="text-sm text-indigo-700 mb-4">{profile.description}</p>
...
export default UserServerProfileCard;
