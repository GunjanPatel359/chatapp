...
const UserProfile = () => {
  ...
  const handleImageChange = (e) => {
    ...
    reader.onloadend = () => {
      ...
      // Optional: upload to server API here
    };
  ...
  return (
    <div className="flex justify-center bg-gray-50 p-6 text-gray-900">
      <div className="bg-white shadow-md rounded-xl w-full max-w-2xl">
        ...
        <div className="flex items-center gap-4 pb-0 p-6 pt-0 translate-y-[-15px] relative">
          {/* Avatar with Upload */}
          <label htmlFor="avatar-upload" className="cursor-pointer">
            <img
              src={user.imageUrl || "/demoProfileImg.jpg"}
              alt="avatar"
              className="w-28 h-28 rounded-full border-[8px] border-white bg-white translate-y-[-22px] object-cover"
            />
            <input
              id="avatar-upload"
              type="file"
